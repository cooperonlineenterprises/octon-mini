...
`assets/blueprint-source/docs/GUIDED_SETUP.md` and the authoritative
`assets/blueprint-source/shared/source-contracts/setup-questions.json`.
...
8. Reinspect on changed target/revision, instructions, catalog, Blueprint
